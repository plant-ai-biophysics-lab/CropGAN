...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--epoch_start_idx', type=int, default=1, help='the starting epoch count, we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>, ...')
        ...
        parser.add_argument('--ssim_loss', action='store_true', default=False, help='use ssim loss')
        ...
        parser.add_argument('--test_path', type=str, default='', help='test image path')
        self.isTrain = True
        return parser
