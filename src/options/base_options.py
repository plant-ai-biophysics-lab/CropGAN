...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='double_task_cycle_gan', help='chooses which model to use. [cycle_gan | pix2pix | test | colorization]')
        ...
        parser.add_argument('--strong_aug', action='store_true', help='Apply strong augs to dataset')
        parser.add_argument('--masked_aug', action='store_true', help='Apply region-masked augmentation to dataset')
