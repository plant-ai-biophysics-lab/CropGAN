...
def detect_directory(model_path, weights_path, img_path, groundtruth, classes, output_path,
    ...
    _draw_and_save_output_images(
        img_detections, imgs, img_size, output_path, classes, groundtruth)
...
def _draw_and_save_output_images(img_detections, imgs, img_size, output_path, classes, groundtruth):
