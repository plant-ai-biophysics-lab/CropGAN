...
class CropGanStandardROIHeadsPseudoLab(StandardROIHeads):
    @classmethod
    ...
    ## If adaptive_teacher removed the dependency on detectron2.modeling.roi_heads.fast_rcnn.FastRCNNOutputs, 
    # I wouldn't need the below. I could just inherit from StandardROIHeadsPseudoLab.
